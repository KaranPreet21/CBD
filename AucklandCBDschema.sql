...
--
-- Host: 127.0.0.1    Database: school_resources_db
-- ------------------------------------------------------
...
CREATE TABLE `articles` (
  ...
  CONSTRAINT `articles_ibfk_1` FOREIGN KEY (`SubjectID`) REFERENCES `subjects` (`SubjectID`),
  CONSTRAINT `articles_ibfk_2` FOREIGN KEY (`PersonID`) REFERENCES `people` (`PersonID`)
...
CREATE TABLE `people` (
  ...
  `Died` varchar(50) DEFAULT NULL,
  `Nationality` varchar(50) DEFAULT NULL,
  `KnownFor` varchar(255) DEFAULT NULL,
  `NotableWork` varchar(255) DEFAULT NULL,
  `About` text,
...
INSERT INTO `users` VALUES (1,'Onkar Nath','onkar@example.com','onkar123',1),(2,'Gagandeep Singh','gagandeep@example.com','gagan123',2),(3,'Karan Preet Singh','karan@example.com','karan123',3),(4,'Gurkaram Singh','gurkaram@example.com','gurkaram123',3);
...
--
-- Dumping routines for database 'school_resources_db'
--
...
-- Dump completed on 2025-07-02  2:29:26
